...
var n = biFromString(
		'',
		10);
var e = biFromString('65537', 10);
function enc(data) {
	var utf8 = toUTF8Array(data);
	var sss = "";
	var c1;
	for ( var i = 0; i < utf8.length; i++) {
		c1 = "00" + utf8[i].toString(16);
		sss = sss + c1.substring(c1.length - 2, c1.length);
	}
	var indata = biFromString(sss, 16);
	var bb = biPowMod(indata, e, n);
	return biToString(bb, 16);
}