...
function fnStringJM2(e) {
    return des(tdObj.key, HexTostring(e), 0, 0)
}
function fnStringJM(e) {
    return stringToHex(des(tdObj.key, e, 1, 0))
}
var tdObj = new Object;
tdObj.key = "#@zstuandaijjmzfc!#", String.prototype.trim = function() {
    ...
    var n, o = this.getTime() - e.getTime();
    switch (t) {
        case "ms":
            n = 1;
            break;
